...
$male = "SELECT count(reg_id) AS total FROM regist_db WHERE reg_course='BS Information Technology'";
$rows_results = mysqli_query($db, $male);
$values = mysqli_fetch_assoc($rows_results);
$num_male = $values['total'];

$getStudent = mysqli_query($db, "SELECT * FROM regist_db WHERE reg_course='BS Information Technology'");
...
<h1 style="text-align:center;margin-top:-50px;">List of TES Grantees in BS Information Technology</h1>
