...
$male = "SELECT count(reg_id) AS total FROM regist_db WHERE reg_atm='with ATM'";
...
<h1 style="text-align:center;margin-top:-50px;">List of TES Grantees with ATM</h1>
...
$getStudent = mysqli_query($db, "SELECT * FROM regist_db WHERE reg_atm='with ATM'");
