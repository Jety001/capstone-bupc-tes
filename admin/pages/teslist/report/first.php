...
$male = "SELECT count(reg_id) AS total FROM regist_db WHERE reg_year='1st'";
...
<h1 style="text-align:center;margin-top:-50px;">List of TES Grantees in First Year</h1>
...
$getStudent = mysqli_query($db, "SELECT * FROM regist_db WHERE reg_year='1st'");
