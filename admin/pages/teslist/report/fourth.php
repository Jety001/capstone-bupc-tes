...
$male = "SELECT count(reg_id) AS total FROM regist_db WHERE reg_year='4th'";
...
<h1 style="text-align:center;margin-top:-50px;">List of TES Grantees in Fourth Year</h1>
...
$getStudent = mysqli_query($db, "SELECT * FROM regist_db WHERE reg_year='4th'");
