...
$male = "SELECT count(reg_id) AS total FROM regist_db";
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'BUPC TES GRANTEES AY 2020-2021', 'Bicol Univeristy Polangui Campus', 'Polangui, Albay');
...
<h1 style="text-align:center;margin-top:-50px;">List of TES Grantees AY 2020-2021</h1>
...
$getStudent = mysqli_query($db, "SELECT * FROM regist_db");
